...
void configTimeBase(TIM_TypeDef *tim, uint16_t period, uint8_t mhz)
{
    ...
    timeHandle[timerIndex].Handle.Init.Prescaler = (SystemCoreClock / ((uint32_t)mhz * 1000000)) - 1;
    timeHandle[timerIndex].Handle.Init.ClockDivision = 0;
...
// TODO: HAL merge one implemented in base
